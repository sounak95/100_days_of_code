...
def rootToLeafPathsSumToK(root, k, str1=""):
    ...
    if root.left ==None and root.right ==None:
        if k==root.data:
            print((str1 + " " + str(root.data)).strip())
            return
        else:
            return

    rootToLeafPathsSumToK(root.left, k-root.data, str1+ " " + str(root.data))
    rootToLeafPathsSumToK(root.right, k - root.data, str1 +  " " + str(root.data))
